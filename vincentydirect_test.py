...
# -------------------------------------------------------------------------
#lat1deg: -1.205952 (NEED IN DEGREES)
#lon1deg: 110.094743499814(NEED IN DEGREES)
#brg12deg: 277.096 (NEED TO ADJUST FOR TRUE NORTH)
#dist: (CALCULATE FROM ground-surface distance formula (Felipe-García et al., 2012)

def vincentydirect(-1.205952, lon1deg,  277.096, dist):
    import math
